...
function endModule() {
    ...
    alert("Module Complete! You've mastered:completed all the modules which we have prepared as for now");

    // Redirect to another page (e.g., summary.html or nextModule.html)
    window.location.href = "C:/Users/selva/Desktop/game/homepage.html";
}